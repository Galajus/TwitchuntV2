...
public class TwitchuntCommandSpigot implements CommandExecutor, TabCompleter {
    ...
    public TwitchuntCommandSpigot(Twitchunt twitchunt, CommandsHelper commandsHelper, DependencyResolver dependencyResolver, ConfigReader configReader) {
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (args[0].isBlank()) {
                suggestions.addAll(commandsHelper.getCommandTwitchuntArgsList());
            } else {
                StringUtil.copyPartialMatches(args[0], commandsHelper.getCommandTwitchuntArgsList(), suggestions);
            }
        }
        if (args.length > 1) {
            if (args[0].equalsIgnoreCase("addhunted")) {
            ...
            if (args[0].equalsIgnoreCase("removehunted")) {
                suggestions.addAll(configReader.getHuntedPlayersAsStrings());
            }

            if (args[0].equalsIgnoreCase("twitchmessages")) {

                if (args.length == 2) {
                    StringUtil.copyPartialMatches(args[1], commandsHelper.getCommandTwitchuntChoicesArgsList(), suggestions);
                }
            }
            ...
            if (args[0].equalsIgnoreCase("setpollinterval") || args[0].equalsIgnoreCase("setpollduration")) {
